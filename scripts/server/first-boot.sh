...
set_section "Setup Complete"
show_log "Server setup has been completed successfully"
show_log "You can now set up individual applications with scripts in: ${SETUP_DIR}/app-setup"
show_log ""
show_log "Next steps:"
show_log "1. Set up applications: cd ${SETUP_DIR}/app-setup && ./plex-setup.sh"
